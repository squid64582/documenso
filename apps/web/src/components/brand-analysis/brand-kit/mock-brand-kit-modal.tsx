...
// Mock integrated stores
const MOCK_STORES = [
  {
    id: 'store-1',
    name: 'Lifeboost Coffee',
    url: 'https://lifeboostcoffee.com',
  ...
  },
  {
    id: 'store-2',
    name: 'Eco Essentials',
    url: 'https://eco-essentials.myshopify.com',
    logoUrl: '/placeholder.svg?height=40&width=40',
    platform: 'shopify',
  },
  {
    ...
    url: 'https://mountaingear.myshopify.com',
    logoUrl: '/placeholder.svg?height=40&width=40',
...
export function BrandKitModal({
  ...
  // In a real app, this would be determined by checking if the user has any integrated stores
  const [hasIntegratedStores, setHasIntegratedStores] = useState(true);
  ...
  const handleSubmit = (e?: React.FormEvent) => {
    ...
    // Simulate the AI agent team starting to work

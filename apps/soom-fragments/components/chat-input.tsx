  ...
  return (
    ...
    >
        ...
        >
          ...
          <button
            className={`px-2 py-1 rounded-sm ${
              isRateLimited ? 'bg-rose-400/20' : 'bg-rose-400/20'
            }`}
            onClick={retry}
          >
            Try again
      ...
      <div className="relative">
        ...
        <div className={`shadow-md rounded-md relative z-10 bg-background border ${
          dragActive 
      ...
      <p className="text-xs text-muted-foreground mt-2 text-center">
        All Rights Reserved {' '}
        <a href="https://soom.io" target="_blank" className="text-[#e11d47]">
          ✶ Soom
        </a>
      </p>
    </form>

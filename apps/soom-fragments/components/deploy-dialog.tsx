    ...
    <DropdownMenu>
      <DropdownMenuTrigger asChild>
        <Button variant="outline">
          <Logo style="e2b" width={16} height={16} className="mr-2 mb-0.5" />
          <span className={`${GeistMono.className} text-xs`}>Deploy to s1</span>
        </Button>
      </DropdownMenuTrigger>
      <DropdownMenuContent className="p-4 w-80 flex flex-col gap-2">
        <div className="text-sm font-semibold">Deploy to Soom s1</div>
